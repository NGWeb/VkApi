...
{
    public class IvkApiPhotoSize : IVKApiModel, IIdentifiable
    {
        /**
     ...
     */
        ...
        public int compareTo(IvkApiPhotoSize another)
        {
     ...
     */
        ...
        public IvkApiPhotoSize parse(JObject source, int originalWidth, int originalHeight)
        {
            IvkApiPhotoSize result = new IvkApiPhotoSize();
     ...
     */
        ...
        private static void fillDimensions(IvkApiPhotoSize result, int originalWidth, int originalHeight)
        {
     ...
     */
        ...
        private static void fillDimensionSMXY(IvkApiPhotoSize result, float ratio, int width)
        {
            result.width = width;
     ...
     */
        ...
        private static void fillDimensionOPQ(IvkApiPhotoSize result, float ratio, int width)
        {
     ...
     */
        ...
        private static void fillDimensionZW(IvkApiPhotoSize result, float ratio, int allowedWidth, int allowedHeight)
        {
            if (ratio > 1)
            {
     ...
     */
        ...
        public static IvkApiPhotoSize create(string url, int width, int height)
        {
            IvkApiPhotoSize result = new IvkApiPhotoSize();
            result.src = url;
            result.width = width;
     ...
     */
        ...
        public static IvkApiPhotoSize create(string url, char type, int originalWidth, int originalHeight)
        {
            IvkApiPhotoSize result = new IvkApiPhotoSize();
            result.src = url;
            result.type = type;
     ...
     */
        ...
        public static IvkApiPhotoSize create(string url, int dimension)
        {
